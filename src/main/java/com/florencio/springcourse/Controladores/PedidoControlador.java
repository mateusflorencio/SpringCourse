...
import com.florencio.springcourse.services.PedidoService;
...
public class PedidoControlador{
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody Pedido obj){ //o requestBody é para converte o json para java
